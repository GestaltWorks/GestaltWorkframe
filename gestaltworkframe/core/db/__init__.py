...
package so existing `from gestaltworkframe.core.db import X` imports keep working.
...
from gestaltworkframe.core.db.engine import (
    DEFAULT_SQLITE_PATH,
    async_session_maker,
...
from gestaltworkframe.core.db.migrations import init_db
